...
import { GlobeDemo } from "./GridGlove";
...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('priyansudash@gmail.com')
    setCopied(true)
  }
      ...
      {id === 3 && (
        <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
          <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
            ...
            <span key={item} className="md:py-4 md:px-3 py-2 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
              {item}
            </span>
            ))} 
          ...
          <div className="flex flex-col gap-3 md:gap-3 lg:gap-8">
            {['Github', 'Postman', 'My SQL'].map((item) => (
            <span key={item} className="md:py-4 md:px-3 py-2 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]">
              {item}
            </span>
            ))} 
